    ...
    override val values: Sequence<List<Movie>> = sequenceOf(
        listOf(
            ...
            Movie(
                ...
                overview = "When the menace known as the Joker wreaks havoc on Gotham City, Batman must accept one of the greatest tests.",
            ...
            Movie(
                ...
                overview = "In German-occupied Poland during World War II, industrialist Oskar Schindler saves Jewish refugees.",
